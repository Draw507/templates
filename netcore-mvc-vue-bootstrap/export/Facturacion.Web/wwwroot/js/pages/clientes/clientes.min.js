...
let clientes=function(e,n){let t,i={urlIndexGrid:"#urlgetclientes",grid:"#grid-clientes"},a={},r=function(){$(i.grid).DataTable().draw()},o=function(){$(i.grid).hasClass("initialized")||(t=$(i.grid).DataTable({responsive:!0,lengthMenu:InitApp.dataTableGridOptions.lengthMenu,pageLength:10,searching:!1,ordering:!0,order:[[1,"desc"]],processing:!1,language:InitApp.dataTableGridOptions.language.es,serverSide:!0,stateSave:!1,pagingType:"full_numbers",ajax:{url:$(i.urlIndexGrid).val(),type:"POST",contentType:"application/json; charset=utf-8",beforeSend:function(){InitApp.showLoading()},data:function(e){return e.filters={Nombre:"Yo"},JSON.stringify(e)},dataSrc:function(e){if(InitApp.hideLoading(),e.success)return e.data;alert(e.message)}},columns:[{data:"Nombre"},{data:"Identificacion"},{data:"Telefono1"},{data:"Telefono2"}],rowCallback:function(e,n,t){},drawCallback:function(e){$(i.grid).DataTable().columns.adjust().responsive.recalc()}}),$(i.grid).not(".initialized").addClass("initialized").dataTable())};return{init:function(){a.Document=$(document),o()},reDrawGrid:r}}(window);$((function(){clientes.init()}));const appClientes=new Vue({el:"#app-clientes",data:{url:"",resources:{unexpectedError:"Ha ocurrido un error inesperado"}},methods:{localizer:function(e){return this.resources[e]},showFormCreate:function(){}},computed:{},beforeMount:function(){},mounted:function(){}});